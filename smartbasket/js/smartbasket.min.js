    ...
    t = jQuery, a = {
        ...
        showProducts: function(s) {
            let r = t("<form>").attr({
                ...
                }).html("Price for product").append(p),
                u = t("<div>").attr({
            ...
            for (let n in s) {
                ...
                for (let a in s[n]) {
                    ...
                    if ("sbName" === a && (c.append(`<span>${s[n][a]}</span>`), p.val(s[n][a])), "sbSize" === a && void 0 !== s[n][a] && (c.children("span").append(`<span class="smart-basket__product-size"> type: ${s[n][a]}</span>`), d.val(s[n][a])), "sbPrice" === a && (_.html(s[n][a]), h.val(s[n][a])), "sbPriceCommon" === a) {
                        let t = +s[n][a];
                        y.val(+t.toFixed(2))
                    }
        ...
        stateBasket: function() {
            ...
            } else console.log("Fill in the options productSize и productPrice");
            return e.getSmartBasketMinState(o), c.click(function() {
                let r = e.getProducts() || {},
                    n = t(this).attr("data-sb-id-or-vendor-code");
                if (void 0 !== r[n]) {
                    let a = t(this).html();
                    return t(this).text("The product is already in the basket"), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => {
                        t(this).html(a)
                    }, 1500), !1
                } {
                    let i = {};
        ...
        commonResult: function(e, s, r) {
            let n = 0,
                ...
                }).text("The basket is empty. You have not added any products").fadeOut(),
                l = t("<div>").attr({
                    class: "smart-basket__success-title"
                }).text("Order accepted. Expect notifications in the mail during the day.").css("display", "none"),
                c = t("<div>").attr({
            ...
            if (0 == +n ? o.fadeIn() : o.fadeOut(), r) t("." + l.attr("class")).css("display", "block"), setTimeout(() => {
                ...
                if (!s) return d.html(`<span>Total products: </span> ${n}`), p.html(`<span>Total cost: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(2)} ${a.smartBasketCurrency}">`), c.append(o).append(l).append(d).append(p), c;
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                let e = t("<label>").attr({
                    ...
                    s = t("<input>").attr({
                        ...
                        value: "I accept the terms of the user agreement"
                    }),
                    r = null;
                r = a.agreement.isLink ? t("<a>").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("I accept the terms of the user agreement") : r.text("I do not accept the terms of the user agreement"), e.click(function() {
                    s.is(":checked") ? (r.text("I do not accept the terms of the user agreement"), s.val("I do not accept the terms of the user agreement"), m.attr({
                        disabled: "disabled"
                    }), d.addClass("smart-basket__input-wrapper_error")) : (r.text("I accept the terms of the user agreement"), s.val("I accept the terms of the user agreement"), m.attr({
                        disabled: !1
        ...
        return e[a] ? e[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof a && a ? void t.error("Method " + a + " not found") : e.init.apply(this, arguments)
    }
});
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let button = document.querySelector(".smart-basket__send-form");
...
document.getElementByClassName("smart-basket__form").addEventListener("submit", function (e) {
    e.preventDefault();
    console.log("yes");
